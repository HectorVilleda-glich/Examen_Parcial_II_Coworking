...
export default function AdminReservationsPage() {
  ...
  const load = () => api.get('/reservations').then(res => setReservations(res.data)).catch(() => {});
  useEffect(() => { load(); }, []);
  ...
  return (
    <>
      <div className="page-header">
        ...
        <p>Vista administrativa de todas las reservaciones del sistema</p>
      </div>
      ...
      {filtered.length === 0 ? (
        <div className="empty">
          ...
          <p>Aun no se han creado reservaciones en el sistema</p>
        </div>
      ) : (
            ...
            <div key={res.id} className="res-row">
              ...
              <div className="res-info">
                ...
                <div className="res-detail">
                  {res.user?.name || `Usuario #${res.userId}`} &middot; {res.space?.location || ''}
                </div>
              </div>
